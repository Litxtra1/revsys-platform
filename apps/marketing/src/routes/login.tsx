...
import { PageShell, RevsysMark } from "../components/revsys/shared";
...
export const Route = createFileRoute("/login")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Sign in to your Revsys AI Mission Control and open your latest Revenue Report.",
      },
    ...
    <PageShell>
      <AuthShell
        ...
        footer={
          <>
            New to Revsys?{" "}
            <Link to="/signup" className="font-medium text-revenue hover:brightness-110">
...
export function AuthShell({
  ...
  showStore?: boolean;
  onSubmit: (input: { email: string; password: string; store: string }) => Promise<{ error?: string }>;
}) {
