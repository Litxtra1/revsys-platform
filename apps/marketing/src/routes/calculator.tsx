...
export const Route = createFileRoute("/calculator")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Revenue Opportunity Calculator — Revsys AI" },
      {
        property: "og:description",
        content:
          "Enter your GMV, sessions and conversion. See what Revsys typically recovers in the first 90 days.",
      },
    ],
  }),
